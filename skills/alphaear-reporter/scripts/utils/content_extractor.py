...
class ContentExtractor:
    ...
    # 速率限制配置 (无 API Key 時：20 次/分鐘)
    _rate_limit_no_key = 20  # 每分鐘最大請求数
    _rate_window = 60.0  # 時間窗口（秒）
    _min_interval = 3.0  # 請求最小间隔（秒）
    ...
    def extract_with_jina(cls, url: str, timeout: int = 30) -> Optional[str]:
        ...
        无 API Key 時自動限速：每分鐘最多 20 次請求，每次间隔至少 3 秒
        """
